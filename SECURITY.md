...
- Dext Git checkpoints are best-effort local recovery aids. They may include
  ...
  checkpoint failures. Regular-file content is stored
  ...
  Unsafe or malformed entries in the blob directory remain untouched for inspection and produce
  bounded warnings without stopping other retention cleanup.
