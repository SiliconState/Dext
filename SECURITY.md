...
- Dext Git checkpoints are best-effort local recovery aids. They may include
  ...
  unchanged blobs, and pruning or a failed checkpoint creation removes unreferenced/new blobs.
