...
impl<B: Backend> Terminal<B> {
    ...
    fn insert_before_no_scrolling_regions(
        ...
        // The fallback controls the cursor explicitly while drawing and leaves it at the viewport
        // origin before this clear. Querying it again here adds a synchronous terminal round trip
        // and races the application's input reader on Crossterm.
        self.clear_viewport()?;
